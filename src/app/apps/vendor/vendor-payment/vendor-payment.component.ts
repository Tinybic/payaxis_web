...
import { vendorpayment_deactivate, vendorpayment_list, vendorpayment_new, vendorpayment_setdefault, vendorpayment_update } from 'src/app/core/gql/vendor-payment';
